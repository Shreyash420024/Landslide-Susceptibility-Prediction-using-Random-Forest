...
cbar.set_label('Rainfall (units)')

# Set plot title and labels
plt.title('Rainfall Distribution in India (June-July 2022)')
plt.xlabel('Longitude')
plt.ylabel('Latitude')

# Save the plot to a file (you can choose either PNG or JPEG)
plt.savefig('rainfall_map_june_july.png', bbox_inches='tight')
# or
# plt.savefig('rainfall_map_june_july.jpg', bbox_inches='tight')
